...
| 类型 | 路径 |
|------|------|
| 安装目录 | /opt/redis-cluster |
| 配置目录 | /etc/redis-cluster |
| 日志目录 | /var/log/redis-cluster |
| 数据目录 | /var/lib/redis-cluster |

---

## 常见问题

### Q: 如何安装 Redis Cluster？
A: 请参考官方文档或 README.md 中的说明。

### Q: 服务无法启动？
A: 查看日志文件 /var/log/redis-cluster 中的错误信息。
